...
crime_data <- read.csv('/media/enero/Disco1/Varios/R/Archivos/clases_r/h2o/data/Crime_Data_from_2010_to_Present-08-05-2018.csv')
```
...
```{r}
# training hasta el año agosto 2017
training   <- crime_data[crime_data$date_occurred<as.Date('2017-09-01'), ]

# Validating el año septiembre-diciembre 2017
validating <- crime_data[(crime_data$date_occurred>as.Date('2017-08-31') & crime_data$date_occurred<as.Date('2018-01-01')), ]
...
write_csv(training, './data/training.csv')

# Validating el año 2017
write_csv(validating, './data/validating.csv')

# testing el año 2018
write_csv(testing, './data/testing.csv')
```
...
h2o.init(nthreads=-1, port=55555, max_mem_size="95G")
```
